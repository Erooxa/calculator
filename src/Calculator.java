...
public class Calculator implements ActionListener{
    ...
    Calculator(){
        ...
        frame = new JFrame("Ernar's Calculator");
        ...
        for(int i =0;i<9;i++) {
            ...
            functionButtons[i].setBorder(new RoundedBorder(25));
            functionButtons[i].setBackground(c);
        ...
        for(int i =0;i<10;i++) {
            ...
            numberButtons[i].setBorder(new RoundedBorder(25));
            numberButtons[i].setBackground(Color.green);
            numberButtons[i].setOpaque(true);
        }

        negButton.setBounds(50,430,100,50);
        negButton.setBorder(new RoundedBorder(25));
        ...
        delButton.setBorder(new RoundedBorder(25));
        delButton.setBackground(Color.yellow);
        delButton.setOpaque(true);
        delButton.setContentAreaFilled(false);

        clrButton.setBounds(250,430,100,50);
        clrButton.setBorder(new RoundedBorder(25));
